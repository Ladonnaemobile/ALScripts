...
function var_0_1.DoWave(arg_3_0)
	...
	if var_3_0 then
		...
		local var_3_5 = var_0_0.Battle.BattleDataProxy.GetInstance():GetInitData().isMemory

		ChapterOpCommand.PlayChapterStory(arg_3_0._storyID, var_3_4, var_3_1, var_3_5)
		gcAll()
	else
		arg_3_0:doPass()
	end
