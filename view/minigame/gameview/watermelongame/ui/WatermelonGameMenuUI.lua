...
function var_0_0.setGameRoomUI(arg_11_0, arg_11_1)
	if arg_11_1 then
		setActive(findTF(arg_11_0.menuUI, "lastTimes"), false)
		setActive(findTF(arg_11_0.menuUI, "btnRank"), false)
	end
end
...
function var_0_0.CheckGet(arg_13_0)
	...
	if var_13_1 == 0 then
		if arg_13_0._gameVo.totalTimes > arg_13_0:getGameUsedTimes(var_13_0) then
			return
		end
