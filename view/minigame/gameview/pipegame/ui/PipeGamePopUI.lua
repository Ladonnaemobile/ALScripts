...
function var_0_0.updateSettlementUI(arg_19_0)
	...
	if var_19_0 > 0 and var_19_3 < var_19_0 then
		arg_19_0._event:emit(PipeGameEvent.STORE_SERVER, {
			var_19_0,
			var_19_1
		})
