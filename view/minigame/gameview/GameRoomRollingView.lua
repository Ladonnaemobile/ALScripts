local var_0_0 = class("GameRoomRollingView", import("..BaseMiniGameView"))
...
function var_0_0.showScoreUI(arg_11_0, arg_11_1)
	...
	var_11_0 = arg_11_1 < var_11_0 and var_11_0 or arg_11_1

	setActive(arg_11_0.scoreUI, true)
	setText(arg_11_0.labelCurScore, arg_11_1)
	setText(arg_11_0.labelHigh, var_11_0)
...
function var_0_0.checkSuccessGrid(arg_42_0)
	...
	seriesAsync({
		...
		function(arg_44_0)
			if var_42_0 then
				LeanTween.delayedCall(go(arg_42_0.rollingUI), 0.2, System.Action(function()
					arg_44_0()
				end))
...
function var_0_0.updateScore(arg_50_0, arg_50_1)
	...
	LeanTween.delayedCall(go(arg_50_0.labelGameScore), 0.2, System.Action(function()
