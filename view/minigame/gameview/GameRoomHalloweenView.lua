	...
	function var_91_0.step(arg_94_0)
		...
		if arg_94_0.speedLevel <= #var_0_15 then
			...
			if var_0_30 >= arg_94_0.nextSpeedUpTime then
				...
				var_0_36("幽灵生成速度提升" .. (arg_94_0.nextSpeedUpTime or "(已经达到最高速度)"))
			end
		end
	end
...
function var_0_0.initData(arg_125_0)
	...
	if not arg_125_0.handle then
		arg_125_0.handle = UpdateBeat:CreateListener(arg_125_0.Update, arg_125_0)
	end
...
function var_0_0.loseHeart(arg_151_0, arg_151_1)
	if arg_151_0.heartNum and arg_151_0.heartNum > 0 then
		...
		if arg_151_0.heartNum == 0 then
			local var_151_0 = arg_151_1 == var_0_5 and var_0_7 or var_0_8
...
function var_0_0.showSettlement(arg_156_0)
	...
	local var_156_0 = arg_156_0.scoreNum
	local var_156_1 = getProxy(GameRoomProxy):getRoomScore(arg_156_0:getGameRoomData().id)

	if var_156_1 <= var_156_0 then
		var_156_1 = var_156_0
	...
	local var_156_2 = findTF(arg_156_0.settlementUI, "ad/highText")
	local var_156_3 = findTF(arg_156_0.settlementUI, "ad/currentText")

	setText(var_156_2, var_156_1)
	setText(var_156_3, var_156_0)
end
