local var_0_0 = class("GameRoomTreasureView", import("..BaseMiniGameView"))
...
local var_0_7 = 60
local var_0_8 = "ui/minigameui/islandcatchtreasuregameui_atlas"
...
function var_0_0.initUI(arg_70_0)
	...
	onButton(arg_70_0, findTF(arg_70_0.menuUI, "btnStart"), function()
		...
		arg_70_0:openCoinLayer(false)
		arg_70_0:readyStart()
	end, SFX_CANCEL)
	onButton(arg_70_0, findTF(arg_70_0.menuUI, "btnRule"), function()
		pg.MsgboxMgr.GetInstance():ShowMsgBox({
			type = MSGBOX_TYPE_HELP,
			helps = arg_70_0:getGameRoomData().game_help
		})
	end, SFX_CANCEL)
...
function var_0_0.initGameUI(arg_80_0)
	arg_80_0.gameUI = findTF(arg_80_0._tf, "ui/gameUI")

	onButton(arg_80_0, findTF(arg_80_0.gameUI, "topRight/btnStop"), function()
		arg_80_0:stopGame()
		setActive(arg_80_0.pauseUI, true)
	end)
	onButton(arg_80_0, findTF(arg_80_0.gameUI, "btnLeave"), function()
		arg_80_0:stopGame()
		setActive(arg_80_0.leaveUI, true)
	end)

	arg_80_0.dragDelegate = GetOrAddComponent(arg_80_0.sceneTf, "EventTriggerListener")
	arg_80_0.dragDelegate.enabled = true

	arg_80_0.dragDelegate:AddPointDownFunc(function(arg_83_0, arg_83_1)
		if arg_80_0.boatController then
			arg_80_0.boatController:throw()
		end
	end)

	arg_80_0.gameTimeS = findTF(arg_80_0.gameUI, "top/time/s")
	arg_80_0.scoreTf = findTF(arg_80_0.gameUI, "top/score")
	arg_80_0.boatController = var_0_56(arg_80_0.sceneTf, arg_80_0)
	arg_80_0.itemController = var_0_57(arg_80_0.sceneTf, arg_80_0.backSceneTf, arg_80_0:getGameUsedTimes(), arg_80_0)
	arg_80_0.catchController = var_0_58(arg_80_0.boatController, arg_80_0.itemController)
	arg_80_0.charController = var_0_59(arg_80_0.backSceneTf, arg_80_0)
	arg_80_0.sceneScoreTf = findTF(arg_80_0.sceneTf, "scoreTf")

	setActive(arg_80_0.sceneScoreTf, false)
end

function var_0_0.Update(arg_84_0)
	arg_84_0:AddDebugInput()
end

function var_0_0.AddDebugInput(arg_85_0)
...
function var_0_0.updateMenuUI(arg_86_0)
	return
end

function var_0_0.openMenuUI(arg_87_0)
	setActive(findTF(arg_87_0._tf, "scene_container"), false)
	setActive(findTF(arg_87_0.bgTf, "on"), true)
	setActive(arg_87_0.gameUI, false)
	setActive(arg_87_0.menuUI, true)
	arg_87_0:openCoinLayer(true)
	arg_87_0:updateMenuUI()
end

function var_0_0.clearUI(arg_88_0)
	setActive(arg_88_0.sceneTf, false)
	setActive(arg_88_0.settlementUI, false)
	setActive(arg_88_0.countUI, false)
	setActive(arg_88_0.menuUI, false)
	setActive(arg_88_0.gameUI, false)
end

function var_0_0.readyStart(arg_89_0)
	setActive(arg_89_0.countUI, true)
	arg_89_0.countAnimator:Play("count")
	pg.CriMgr.GetInstance():PlaySoundEffect_V3(var_0_2)
end

function var_0_0.getGameTimes(arg_90_0)
	return arg_90_0:GetMGHubData().count
end

function var_0_0.getGameUsedTimes(arg_91_0)
	return arg_91_0:GetMGHubData().usedtime
end

function var_0_0.getUltimate(arg_92_0)
	return arg_92_0:GetMGHubData().ultimate
end

function var_0_0.gameStart(arg_93_0)
	setActive(findTF(arg_93_0._tf, "scene_container"), true)
	setActive(findTF(arg_93_0.bgTf, "on"), false)
	setActive(arg_93_0.gameUI, true)
	...
	arg_93_0.heart = 3
	arg_93_0.gameTime = var_0_7

	SetActive(arg_93_0.sceneScoreTf, false)

	if arg_93_0.boatController then
		arg_93_0.boatController:start()
	end

	if arg_93_0.itemController then
		arg_93_0.itemController:start()
	end

	if arg_93_0.catchController then
		arg_93_0.catchController:start()
	end

	if arg_93_0.charController then
		arg_93_0.charController:start()
	end
...
function var_0_0.transformColor(arg_94_0, arg_94_1)
	local var_94_0 = tonumber(string.sub(arg_94_1, 1, 2), 16)
	local var_94_1 = tonumber(string.sub(arg_94_1, 3, 4), 16)
	local var_94_2 = tonumber(string.sub(arg_94_1, 5, 6), 16)

	return Color.New(var_94_0 / 255, var_94_1 / 255, var_94_2 / 255)
end

function var_0_0.addScore(arg_95_0, arg_95_1, arg_95_2)
	...
	setActive(arg_95_0.sceneScoreTf, false)

	local var_95_0 = findTF(arg_95_0.sceneScoreTf, "img")
	local var_95_1 = GetComponent(var_95_0, typeof(Text))
	local var_95_2 = "6f1807"

	if arg_95_1 then
		local var_95_3

		for iter_95_0 = 1, #var_0_47 do
			if arg_95_1 and arg_95_1 >= var_0_47[iter_95_0].score then
				var_95_2 = var_0_47[iter_95_0].color
				var_95_3 = var_0_47[iter_95_0].font

				break
			end
		end

		local var_95_4 = arg_95_0:transformColor(var_95_2)

		arg_95_0.scoreNum = arg_95_0.scoreNum + arg_95_1

		local var_95_5 = arg_95_1 >= 0 and "+" or ""

		setText(var_95_0, var_95_5 .. arg_95_1)

		var_95_1.fontSize = var_95_3 or 40

		setTextColor(var_95_0, var_95_4)
	elseif arg_95_2 then
		local var_95_6 = arg_95_0:transformColor("66f2fb")

		var_95_1.fontSize = 40

		setTextColor(var_95_0, var_95_6)

		if arg_95_0.gameTime > 0 then
			arg_95_0.gameTime = arg_95_0.gameTime + arg_95_2
		end

		local var_95_7 = arg_95_2 > 0 and "+" or ""

		setText(var_95_0, var_95_7 .. arg_95_2 .. "s")
	end

	setActive(arg_95_0.sceneScoreTf, true)
end

function var_0_0.onTimer(arg_96_0)
	arg_96_0:gameStep()
end

function var_0_0.gameStep(arg_97_0)
	arg_97_0.gameTime = arg_97_0.gameTime - Time.deltaTime
	arg_97_0.gameStepTime = arg_97_0.gameStepTime + Time.deltaTime

	if arg_97_0.boatController then
		arg_97_0.boatController:step()
	end

	if arg_97_0.itemController then
		arg_97_0.itemController:step()
	end

	if arg_97_0.catchController then
		arg_97_0.catchController:step()
	end

	if arg_97_0.charController then
		arg_97_0.charController:step()
	end
...
function var_0_0.timerStart(arg_98_0)
	if not arg_98_0.timer.running then
		arg_98_0.timer:Start()
	end
end

function var_0_0.timerStop(arg_99_0)
	if arg_99_0.timer.running then
		arg_99_0.timer:Stop()
	end
end

function var_0_0.updateGameUI(arg_100_0)
	setText(arg_100_0.scoreTf, arg_100_0.scoreNum)
	setText(arg_100_0.gameTimeS, math.ceil(arg_100_0.gameTime))
end

function var_0_0.onGameOver(arg_101_0)
	...
	setActive(arg_101_0.clickMask, true)

	if arg_101_0.boatController then
		arg_101_0.boatController:gameOver()
	end

	LeanTween.delayedCall(go(arg_101_0._tf), 2, System.Action(function()
		arg_101_0.settlementFlag = false
		arg_101_0.gameStartFlag = false

		setActive(arg_101_0.clickMask, false)
		arg_101_0:showSettlement()
	end))
end

function var_0_0.showSettlement(arg_103_0)
	setActive(arg_103_0.settlementUI, true)
	GetComponent(findTF(arg_103_0.settlementUI, "ad"), typeof(Animator)):Play("settlement", -1, 0)

	local var_103_0 = arg_103_0:GetMGData():GetRuntimeData("elements")
	local var_103_1 = arg_103_0.scoreNum
	local var_103_2 = var_103_0 and #var_103_0 > 0 and var_103_0[1] or 0

	setActive(findTF(arg_103_0.settlementUI, "ad/new"), var_103_2 < var_103_1)
	...
	local var_103_3 = findTF(arg_103_0.settlementUI, "ad/highText")
	local var_103_4 = findTF(arg_103_0.settlementUI, "ad/currentText")

	setText(var_103_3, var_103_2)
	setText(var_103_4, var_103_1)
...
function var_0_0.resumeGame(arg_104_0)
	arg_104_0.gameStop = false

	setActive(arg_104_0.leaveUI, false)
	arg_104_0:timerStart()
end

function var_0_0.stopGame(arg_105_0)
	arg_105_0.gameStop = true

	arg_105_0:timerStop()
end

function var_0_0.onBackPressed(arg_106_0)
	if not arg_106_0.gameStartFlag then
		arg_106_0:emit(var_0_0.ON_BACK_PRESSED)
	else
		if arg_106_0.settlementFlag then
			return
		end

		if isActive(arg_106_0.pauseUI) then
			setActive(arg_106_0.pauseUI, false)
		end

		arg_106_0:stopGame()
		setActive(arg_106_0.leaveUI, true)
	end
end

function var_0_0.willExit(arg_107_0)
	if arg_107_0.handle then
		UpdateBeat:RemoveListener(arg_107_0.handle)
	end

	if arg_107_0._tf and LeanTween.isTweening(go(arg_107_0._tf)) then
		LeanTween.cancel(go(arg_107_0._tf))
	end

	if arg_107_0.timer and arg_107_0.timer.running then
		arg_107_0.timer:Stop()
	end
