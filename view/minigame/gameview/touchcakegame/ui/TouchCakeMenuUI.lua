local var_0_0 = class("TouchCakeMenuUI")
local var_0_1
local var_0_2
...
function var_0_0.Ctor(arg_1_0, arg_1_1, arg_1_2)
	...
	GetComponent(findTF(arg_1_0.menuUI, "lastTimes/img"), typeof(Image)):SetNativeSize()
...
function var_0_0.update(arg_13_0, arg_13_1)
	...
	setActive(findTF(arg_13_0.btnStart, "tip"), var_13_1 > 0)
