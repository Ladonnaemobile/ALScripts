...
function var_0_0.SkillHrzPop(arg_7_0, arg_7_1, arg_7_2, arg_7_3, arg_7_4)
	...
	if arg_7_3 then
		...
		if ys.Battle.BattleState.GetCombatSkinKey() == "Standard" then
			...
			var_7_2 = var_7_0:GetCommanderIcon(arg_7_3)
		end
	else
		...
		if arg_7_2:GetUnitType() == ys.Battle.BattleConst.UnitType.PLAYER_UNIT then
			...
			if ys.Battle.BattleState.GetCombatSkinKey() == "Standard" then
				...
				var_7_2 = var_7_0:GetCharacterSquareIcon(var_7_3)
			end
		elseif ys.Battle.BattleState.GetCombatSkinKey() == "Standard" then
			...
			var_7_2 = var_7_0:GetCharacterSquareIcon(pg.enemy_data_statistics[arg_7_2:GetTemplateID()].icon)
		end
	end
	...
	setText(findTF(var_7_5, "skill/skill_name/Text"), SwitchSpecialChar(HXSet.hxLan(arg_7_1)))

	local var_7_6 = findTF(var_7_5, "skill/icon_mask/icon")
	local var_7_7 = findTF(var_7_5, "skill/skill_name")
	local var_7_8 = var_7_5:GetComponent(typeof(Animation))

	if var_7_8 then
		local var_7_9 = 1

		while var_7_8:GetClip("anim_skinui_skill_" .. var_7_9) do
			var_7_9 = var_7_9 + 1
		end

		if var_7_9 > 1 then
			var_7_8:Play("anim_skinui_skill_" .. math.random(var_7_9 - 1))
		end
	end

	var_7_6:GetComponent(typeof(Image)).sprite = var_7_2

	local var_7_10, var_7_11 = arg_7_2:GetIFF()

	if arg_7_2:GetIFF() == ys.Battle.BattleConfig.FRIENDLY_CODE then
		var_7_11 = Color.New(1, 1, 1, 1)
	else
		var_7_11 = Color.New(1, 0.33, 0.33, 1)
	end

	var_7_7:GetComponent(typeof(Image)).color = var_7_11
	findTF(var_7_5, "skill"):GetComponent(typeof(Image)).color = var_7_11

	if arg_7_3 then
		arg_7_0:commanderSkillFloat(arg_7_3, arg_7_1, var_7_4)
	else
		local var_7_12 = var_0_1.CameraPosToUICamera(arg_7_2:GetPosition():Clone())
		local var_7_13 = ys.Battle.BattleCameraUtil.GetInstance():GetCharacterArrowBarPosition(var_7_12)
		local var_7_14 = table.contains(TeamType.SubShipType, arg_7_2:GetTemplate().type)
		local var_7_15 = arg_7_2:GetMainUnitIndex()

		if var_7_13 == nil or var_7_13 == nil and var_7_14 and not arg_7_2:IsMainFleetUnit() then
			if var_7_10 == ys.Battle.BattleConfig.FRIENDLY_CODE then
				var_7_12 = var_0_1.CameraPosToUICamera(arg_7_2:GetPosition():Clone():Add(var_0_0.IN_VIEW_FRIEND_SKILL_OFFSET))
			else
				var_7_12 = var_0_1.CameraPosToUICamera(arg_7_2:GetPosition():Clone():Add(var_0_0.IN_VIEW_FOE_SKILL_OFFSET))
			end

			var_7_5.position = Vector3(var_7_12.x, var_7_12.y, -2)

			local var_7_16 = rtf(var_7_5).rect.width * 0.5
			local var_7_17 = var_7_5.anchoredPosition
			local var_7_18 = var_7_17.x

			if Screen.width * 0.5 < var_7_16 + var_7_18 then
				var_7_17.x = var_7_18 - rtf(var_7_5).rect.width
				var_7_5.anchoredPosition = var_7_17
			end
			...
			local var_7_19
			local var_7_20 = var_0_0.SIDE_ALIGNMENT[var_7_15]
			local var_7_21 = arg_7_0._sideSkillFloatStateList[var_7_10][var_7_15]

			for iter_7_0 = 1, #var_7_21 do
				if var_7_21[iter_7_0] then
					var_7_19 = iter_7_0
			...
			var_7_21[var_7_19] = false
			var_7_5.position = var_7_13

			local var_7_22 = var_7_5.anchoredPosition

			var_7_22.y = var_7_20[var_7_19]

			if var_7_10 == ys.Battle.BattleConfig.FOE_CODE then
				var_7_22.x = var_0_0.FOE_SIDE_X_OFFSET
			end

			var_7_5.anchoredPosition = var_7_22

			var_7_5:GetComponent(typeof(DftAniEvent)):SetEndEvent(function(arg_9_0)
				var_7_21[var_7_19] = true
...
function var_0_0.didEnter(arg_16_0)
	...
	arg_16_0._chatBtn = arg_16_0:findTF("chatBtn")

	local var_16_1 = arg_16_0._chatBtn:GetComponent(typeof(Animation))

	onButton(arg_16_0, arg_16_0._chatBtn, function()
		arg_16_0:emit(BattleMediator.ON_CHAT, arg_16_0:findTF("chatContainer"))

		if not var_16_1 then
			setActive(arg_16_0._chatBtn, false)
		else
			var_16_1:Play("chatbtn_out")
		end
	end)
	onToggle(arg_16_0, arg_16_0:findTF("AutoBtn"), function(arg_20_0)
		...
		if var_16_0:ChatUseable() then
			setActive(arg_16_0._chatBtn, true)

			if var_16_1 then
				var_16_1:Play("chatbtn_in")
			end
	...
	setActive(arg_16_0._chatBtn, var_16_0:ChatUseable())
end
...
function var_0_0.initPauseWindow(arg_31_0)
	...
	setText(arg_31_0:findTF("label", arg_31_0.LeftTimeContainer), i18n("battle_battleMediator_remainTime"))
	setText(arg_31_0:findTF("window/van/power/title", arg_31_0.pauseWindow), i18n("word_vanguard_fleet"))
	setText(arg_31_0:findTF("window/main/power/title", arg_31_0.pauseWindow), i18n("word_main_fleet"))
	...
	setText(arg_31_0:findTF("pic", arg_31_0.continueBtn), i18n("battle_battleMediator_goOnFight"))
	setText(arg_31_0:findTF("pic", arg_31_0.leaveBtn), i18n("battle_battleMediator_existFight"))
	...
	elseif var_31_4 == SYSTEM_ROUTINE or var_31_4 == SYSTEM_DUEL or var_31_4 == SYSTEM_HP_SHARE_ACT_BOSS or var_31_4 == SYSTEM_BOSS_EXPERIMENT or var_31_4 == SYSTEM_ACT_BOSS or var_31_4 == SYSTEM_ACT_BOSS_SP or var_31_4 == SYSTEM_BOSS_RUSH or var_31_4 == SYSTEM_BOSS_RUSH_EX or var_31_4 == SYSTEM_LIMIT_CHALLENGE or var_31_4 == SYSTEM_BOSS_SINGLE or var_31_4 == SYSTEM_BOSS_SINGLE_VARIABLE then
		setText(var_31_2, "SP")
	...
	onButton(arg_31_0, arg_31_0.leaveBtn, function()
		...
		local var_33_0 = arg_31_0.leaveBtn:GetComponent(typeof(Animation))

		if var_33_0 and var_33_0:GetClip("msgbox_btn_blink") then
			var_33_0:Play("msgbox_btn_blink")
		end
	end)
	onButton(arg_31_0, arg_31_0.continueBtn, function()
		local var_34_0 = arg_31_0.continueBtn:GetComponent(typeof(Animation))

		if var_34_0 and var_34_0:GetClip("msgbox_btn_blink") then
			var_34_0:Play("msgbox_btn_blink")
		end

		local var_34_1 = arg_31_0.pauseWindow:GetComponent(typeof(Animation))

		if var_34_1 then
			if var_34_1:IsPlaying("msgbox_out") then
				var_34_1:Stop("msgbox_out")
				var_34_1:Play("msgbox_in")
			else
				var_34_1:Play("msgbox_out")
				arg_31_0.pauseWindow:GetComponent(typeof(DftAniEvent)):SetEndEvent(function(arg_35_0)
