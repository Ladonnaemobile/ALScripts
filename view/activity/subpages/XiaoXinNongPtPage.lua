local var_0_0 = class("XiaoXinNongPtPage", import(".TemplatePage.PtTemplatePage"))
...
function var_0_0.OnUpdateFlush(arg_4_0)
	...
	setText(arg_4_0.progress, setColorStr(var_4_3, "#7780D3") .. "/" .. setColorStr(var_4_4, "#ffffff"))
