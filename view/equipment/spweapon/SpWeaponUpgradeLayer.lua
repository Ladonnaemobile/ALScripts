	...
	arg_8_0.leftPanelItemRect:make(function(arg_17_0, arg_17_1, arg_17_2)
		...
		if arg_17_0 == UIItemList.EventInit then
			...
			pressPersistTrigger(arg_17_2:Find("IconTpl/Reduce"), 0.5, function(arg_19_0)
				...
				local var_19_1 = arg_8_0:GetSelectMaterial(var_19_0)

				if (var_19_1 and var_19_1.count or 0) == 0 then
					arg_19_0()
				...
				if var_19_1.count <= 0 then
					table.removebyvalue(arg_8_0.consumeItems, var_19_1)
				end
