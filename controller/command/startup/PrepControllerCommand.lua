...
function var_0_0.execute(arg_1_0, arg_1_1)
	...
	arg_1_0.facade:registerCommand(GAME.EXCHANGE_LOVE_LETTER_ITEM, ExchangeLoveLetterItemCommand)
	...
	arg_1_0.facade:registerCommand(GAME.ACTIVITY_UNLOCKSTORYT, ActivityUnlockStoryCommand)
	...
	arg_1_0.facade:registerCommand(GAME.ISLAND_SELL_ITEM, SellIslandItemCommand)
	arg_1_0.facade:registerCommand(GAME.ISLAND_BATCH_SELL_ITEM, BatchSellIslandItemCommand)
	...
	arg_1_0.facade:registerCommand(GAME.ISLAND_UPGRADE_SKILL, IslandUpgradeShipSkillCommand)
	arg_1_0.facade:registerCommand(GAME.ISLAND_GET_EXTRA_AWARD, GetIslandExtraShipAwardCommand)
	arg_1_0.facade:registerCommand(GAME.ISLAND_UNLOCK_BUILDING, IslandUnlockBuildingCommand)
	arg_1_0.facade:registerCommand(GAME.ISLAND_UPGRADE_BUILDING, IslandUpgradeBuildingCommand)
	arg_1_0.facade:registerCommand(GAME.ISLAND_START_PRODUCTION, IslandStartProductionCommand)
	arg_1_0.facade:registerCommand(GAME.ISLAND_START_PRODUCTION_WITH_COST, IslandStartProductionWithCostCommand)
	arg_1_0.facade:registerCommand(GAME.ISLAND_CANCEL_PRODUCTION, IslandCancelProductionCommand)
	arg_1_0.facade:registerCommand(GAME.ISLAND_FINISH_PRODUCTION, IslandFinishProductionCommand)
	arg_1_0.facade:registerCommand(GAME.ISLAND_START_COMMISSION, IslandStartCommissionCommand)
	arg_1_0.facade:registerCommand(GAME.ISLAND_CHANGE_COMMISSION_SHIP, IslandChangeCommissionShipCommand)
	arg_1_0.facade:registerCommand(GAME.ISLAND_CHANGE_COMMISSION_FORMULA, IslandChangeCommissionFormulaCommand)
	arg_1_0.facade:registerCommand(GAME.ISLAND_CANCEL_COMMISSION, IslandCancelCommissionCommand)
	arg_1_0.facade:registerCommand(GAME.ISLAND_GET_COMMISSION_AWARD, IslandGetCommissionAwardCommand)
	...
	arg_1_0.facade:registerCommand(GAME.ISLAND_HEART_BEAT, IslandHeartBeatCommand)
	...
	arg_1_0.facade:registerCommand(GAME.ISLAND_USESPEEDUPCARD, IslandUseSpeedupCardCommand)
